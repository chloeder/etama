                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="/template_home/assets/images/logo/logo.svg" alt="Logo" style="width: 100%">
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="/Admin/src/assets/images/users/profile-pic.jpg" alt="user"
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="app-chat.html"
                                aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                                    class="hide-menu">Belum Diserahkan</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="app-calendar.html"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="open-menu">Unggah Tanda Terima</span></a></li>

                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">Berkas</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">Berkas Pendaftaran</span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="form-input-grid.html" class="sidebar-link"><span
                                            class="hide-menu">Diproses
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="form-checkbox-radio.html"
                                        class="sidebar-link"><span class="hide-menu"> Dikembalikan
                                        </span></a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a
                                            href="/templates/admin/src/html/index.html">Dashboard</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Berkas
                                        Pendaftaran</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="campaign-v2" class="mt-2" style="height:325px; width:100%;"></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="" style="height:375px">
                                    <img src="/Admin/src/assets/images/geografis.png" style="width:110%"
                                        alt="">
                                </div>
